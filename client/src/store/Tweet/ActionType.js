...
export const FIND_TWEET_BY_ID_FAILURE = "FIND_TWEET_BY_ID_REQUEST";

export const REPLY_TWEET_REQUEST = "REPLY_TWEET_REQUEST";
export const REPLY_TWEET_SUCCESS = "REPLY_TWEET_SUCCESS";
export const REPLY_TWEET_FAILURE = "REPLY_TWEET_REQUEST";

export const RETWEET_REQUEST = "RETWEET_REQUEST";
export const RETWEET_SUCCESS = "RETWEET_SUCCESS";
export const RETWEET_FAILURE = "RETWEET_REQUEST";